...
class TestAnalysisService:
    ...
    def sample_test_data(self):
        ...
        return pd.DataFrame({
            ...
            'Serial Number': ['ABC123', 'DEF456', 'GHI789', 'JKL012', 'MNO345', 'PQR678'],
    ...
    def test_perform_analysis_basic_functionality(self, sample_test_data):
        ...
        summary, overall_chart, stations_chart, models_chart, test_cases_chart, stations_data, models_data, test_cases_data = result
    ...
    def test_analysis_with_no_failures(self):
        ...
        if result == (None, None, None, None, None, [], [], []):
            pytest.fail("Analysis failed when it should have succeeded with no failures")
    ...
    def test_date_range_in_summary(self, sample_test_data):
        ...
        lines = summary.split('\n')
        analysis_time_line = [line for line in lines if line.startswith('Analysis Time:')][0]
