...
def analyze_repeated_failures(df: pd.DataFrame, min_failures: int = 4) -> Tuple[str, go.Figure, gr.Dataframe, gr.Dropdown]:
    """
...
def update_summary_chart_and_data(
    repeated_failures_df: pd.DataFrame, 
    sort_by: str, 
...
def handle_test_case_selection(evt: gr.SelectData, selected_test_cases: List[str]) -> List[str]:
    """
