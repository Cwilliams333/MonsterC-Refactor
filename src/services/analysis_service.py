...
def perform_analysis(df: pd.DataFrame) -> Tuple[str, go.Figure, go.Figure, go.Figure, go.Figure, List, List, List]:
    """
    ...
    logger.info("Analysis stats - Total: %d, Valid: %d, Success: %d, Failed: %d, Errors: %d", 
                total_tests, valid_tests, success_tests, failed_tests, error_tests)
